...
//    int arr_length = MAX_REGISTRATION_NUM;
//    int min, min_index;
...
//    printDashes(DASH_NUM);
//    printf("\t\t\t\t\t\t\tSearch Data in Array\n");
//    printDashes(DASH_NUM);
//    for (int i = 0; i < MAX_REGISTRATION_NUM; i++)
//    {
//        char* name = registration[i].name;
//        const char* search_name = "Choi";
//        searchArray(name, search_name, i);
//    }
//
//
//
...
//    for (int i = 0; i < MAX_REGISTRATION_NUM; i++)
//    {
//        char* org = registration[i].org;
//        const char* search_org = "Gachon University";
//        searchArray(org, search_org, i);
//    }
//
//
//    sort_array_data(registration);
//
//    for (int i = 0; i < MAX_REGISTRATION_NUM; i++) {
//        printf("Tag = %2d, Date = %10s, Fee Paid = %3s, Name = %16s, Age = %2d, Org = %32s, Job = %12s",
//            registration[i].tag, registration[i].date, registration[i].is_fee_paid, registration[i].name, registration[i].age, registration[i].org, registration[i].job);
//    }
//
//    const char* sorted_file_name = "sorted_registraion_data.txt";
//
//    if (!ifFileWritten(sorted_file_name, registration)) {
//        return -1;
//    }
//
//
//    int len = 31;
//
//    struct REGISTRATION person = {33, "2020-11-30", "yes", "Gildong Paik", 35, "Gachon University", "Student"};
//
//    insert_data_from_array(registration, &len, person);
//
//    for (int i = 0; i < MAX_REGISTRATION_NUM; i++) {
//        printf("Tag = %2d, Date = %10s, Fee Paid = %3s, Name = %16s, Age = %2d, Org = %32s, Job = %12s",
//            registration[i].tag, registration[i].date, registration[i].is_fee_paid, registration[i].name, registration[i].age, registration[i].org, registration[i].job);
